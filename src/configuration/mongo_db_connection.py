    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                # mongo_db_url = "mongodb+srv://shashanksaad07:UHWl6RUrYU6faB7V@cluster0.uhpusil.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # Retrieve MongoDB URL from environment variables
                if mongo_db_url is None:
                    raise Exception(f"Environment variable '{MONGODB_URL_KEY}' is not set.")
                
                # Establish a new MongoDB client connection
                MongoDBClient.client = pymongo.MongoClient(mongo_db_url, tlsCAFile=ca, connectTimeoutMS=60000, socketTimeoutMS=60000)
...
# Note : This Code will not gonna work until you will not gonna make its object  
